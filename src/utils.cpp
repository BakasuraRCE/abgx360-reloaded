...
int docheckdvdfile() {
    ...
    size_t s;
    FILE *dvdfile;
    char *dvdfilename = new char[strlen(isofilename) + 1]; // char dvdfilename[strlen(isofilename) + 1];
    char *shortisofilename = new char[strlen(isofilename) + 1]; // char shortisofilename[strlen(isofilename) + 1];
